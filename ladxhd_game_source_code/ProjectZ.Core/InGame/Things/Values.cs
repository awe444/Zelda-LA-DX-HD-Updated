...
namespace ProjectZ.InGame.Things
{
    ...
    {
        public static string VersionString = "v1.6.8";
        ...
        // The original game field size was 160x128. The minimum resolution for this port is 320x240.
        // Some menu items may be cropped at this size, which is acceptable.
